...
// Getting Selected Option and Writing Operation Name on Status Card and Calculate Button
...
function showHeight(){
   ...
   * operation, that calls the respective interface, will copy the hard * coded label's text from the .html file like "Height In", "Width In"
   * for rectangleInterface(), which leads to select the unit each time
...
optionsList.forEach(option => {
    option.addEventListener('click', () => {
         ...
         * instantly though it is selected and change in he label texts
         * will be visible if a new operation is selected next
         *      
        */
...
// result showing area - #area and #area1 - control --------------------
    ...
    if(myObject == "Rectangular Cube"){
      ...
      calcNew1.style.transform = "translate(-160%, -400%)"
